...
const ClientContext = createContext<IContext>({} as IContext);
...
export function ClientContextProvider({ children }: { children: ReactNode | ReactNode[] }) {
  ...
  const createClient = useCallback(async () => {
    try {
      ...
      let opts: UniversalProviderOpts = {
        projectId: Config.APP_PROJECT_ID,
        relayUrl: Config.APP_RELAY_URL,
        metadata: {
          name: Config.APP_NAME,
          description: Config.APP_DESCRIPTION,
          url: Config.APP_LINK,
          icons: [Config.APP_ICON_LINK],
        }
      }
